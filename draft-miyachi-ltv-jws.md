...
~~~ ascii-art
  ...
  +---------|----------------|----------------|-------------+
     ...
     +-------------+  +-------------+  +-------------+
~~~
{: title="External Reference Model"}
...
~~~
{: title="Simplified LTV-JWS Structure"}
...
{: title="Signature Input and Timestamp Hash Input Construction"}
...
BASE64URL(signature)
~~~
{: title="Chained Signing Hash Input Construction"}
...
BASE64URL(payload)
~~~
{: title="JWS Signature (SIG-B) Input Construction"}
...
BASE64URL(signature)
~~~
{: title="Signature Timestamp Input Construction"}
...
~~~
{: title="First-Generation Archive Timestamp Input"}
...
~~~
{: title="Second-Generation Archive Timestamp Input"}
...
~~~
{: title="Second-Generation Archive Timestamp Input (rehashes included)"}
...
{: title="Validation Reference Time"}
...
~~~
{: title="Example of SIG-B Decoded payload"}
...
~~~
{: title="Example of SIG-B Decoded protected header"}
...
~~~
{: title="Example of SIG-B value of `header.ltv.signing`"}
...
~~~
{: title="Example of SIG-B using 'x5c'"}
...
~~~
{: title="Example of SIG-T Decoded value of `header.ltv.timestamp`"}
...
~~~
{: title="Example of SIG-LTV Decoded value of `header.ltv.signing`"}
...
~~~
{: title="Example of SIG-LTV Decoded value of `header.ltv.timestamp`"}
...
~~~
{: title="Example of SIG-LTA Decoded value of `header.ltv.archive.timestamp`"}
...
~~~
{: title="Example of SIG-LTV 2nd Decoded value of `header.ltv.archive.timestamp`"}
...
~~~
{: title="Example of SIG-LTA 2nd Decoded value of `header.ltv.archive.archive.timestamp`"}
...
BASE64URL(header.ltv.archive.timestamp)
~~~
{: title="2nd Archive Timestamp Input"}
...
~~~
{: title="Example of SIG-LTA refs renew hashes"}
...
~~~
{: title="Example of SIG-LTA refs renew hashes Decoded value of `header.ltv.archive.archive.rehashes`"}
...
BASE64URL(header.ltv.archive.archive.rehashes)
~~~
{: title="2nd Archive Timestamp Input with rehashed"}
...
~~~
{: title="Example of Chained Signing"}
...
~~~
{: title="Example of Chained Signing Decoded value of `payload`"}
