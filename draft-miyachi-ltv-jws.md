...
~~~
{: name="Simplified LTV-JWS Structure"}
...
BASE64URL(signature)
~~~
{: name="Chained Signing Hash Input Construction"}
...
BASE64URL(payload)
~~~
{: name="JWS Signature (SIG-B) Input Construction"}
...
BASE64URL(signature)
~~~
{: name="Signature Timestamp Input Construction"}
...
~~~
{: name="First-Generation Archive Timestamp Input"}
...
~~~
{: name="Second-Generation Archive Timestamp Input"}
...
~~~
{: name="Second-Generation Archive Timestamp Input (rehashes included)"}
...
~~~
{: name="Example of SIG-B Decoded payload"}
...
~~~
{: name="Example of SIG-B Decoded protected header"}
...
~~~
{: name="Example of SIG-B value of `header.ltv.signing`"}
...
~~~
{: name="Example of SIG-B using 'x5c'"}
...
~~~
{: name="Example of SIG-T Decoded value of `header.ltv.timestamp`"}
...
~~~
{: name="Example of SIG-LTV Decoded value of `header.ltv.signing`"}
...
~~~
{: name="Example of SIG-LTV Decoded value of `header.ltv.timestamp`"}
...
~~~
{: name="Example of SIG-LTA Decoded value of `header.ltv.archive.timestamp`"}
...
~~~
{: name="Example of SIG-LTV 2nd Decoded value of `header.ltv.archive.timestamp`"}
...
~~~
{: name="Example of SIG-LTA 2nd Decoded value of `header.ltv.archive.archive.timestamp`"}
...
BASE64URL(header.ltv.archive.timestamp)
~~~
{: name="2nd Archive Timestamp Input"}
...
~~~
{: name="Example of SIG-LTA refs renew hashes"}
...
~~~
{: name="Example of SIG-LTA refs renew hashes Decoded value of `header.ltv.archive.archive.rehashes`"}
...
BASE64URL(header.ltv.archive.archive.rehashes)
~~~
{: name="2nd Archive Timestamp Input with rehashed"}
...
~~~
{: name="Example of Chained Signing"}
...
~~~
{: name="Example of Chained Signing Decoded value of `payload`"}
